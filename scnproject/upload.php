      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <select name="category_id" id="input-category" class="form-control select2-hidden-accessible" tabindex="-1" aria-hidden="true">
          ...
          <div class="form-group">
            ...
            <textarea name="description" id="input-description" class="form-control" rows="10" placeholder="Schrijf hier wat informatie over het bestand dat je gaat uploaden..."></textarea>
            <p class="help-block">
    ...
    <div class="col-sm-6">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <input type="file" name="images" id="input-images" accept="image/jpeg, image/png" multiple="">
